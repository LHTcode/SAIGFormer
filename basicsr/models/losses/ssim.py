...
from basicsr.models.piq.utils import _validate_input, _reduce
from basicsr.models.piq.functional import gaussian_filter
...
class SSIMLoss(_Loss):
    ...
    def __init__(self, loss_weight=1.0, kernel_size: int = 11, kernel_sigma: float = 1.5, k1: float = 0.01, k2: float = 0.03,
